...
clientID = "TG1sUUxGQlBiYWx2V05NM0pQNUVMQTo2NTU3NTBiNTk1NzM1Y2U2"
...
requestString = "https://a.mapillary.com/v3/objects/?bbox=" + str(lowerx) + "," + str(lowery) + "," + str(upperx) + "," + str(uppery)
boundingbox = requests.get(requestString + "&client_id=" + clientID);
